...
This user guide shows how to use [BLINDED] FLARE to deploy and operate an FL system on multiple sites with a
...
You can also see some `example applications <https://github.com/[BLINDED]/Flare/tree/main/examples>`_ integrating with
`Clara Train <https://docs.[BLINDED].com/clara/clara-train-sdk/>`_ and
`MONAI <https://github.com/Project-MONAI/tutorials/tree/master/federated_learning/flare>`_
