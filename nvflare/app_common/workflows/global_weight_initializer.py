...
from nvflare.app_common.flight_checkers.set_global_weights import SetGlobalWeights, WeightMethod
from nvflare.app_common.app_constant import AppConstants
from .flight_check_ctl import FlightCheckController


class GlobalWeightInitializer(FlightCheckController):
    ...
    def __init__(
        ...
        """
        FlightCheckController.__init__(
            self,
            checker=SetGlobalWeights(
                weights_prop_name=weights_prop_name,
                weight_method=weight_method,
                client_name=weights_client_name
            ),
            task_name=task_name,
